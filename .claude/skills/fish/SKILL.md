...
`_` prefix is this config's ordering mechanism. Load order as of 2026-07-29 — **fifteen** snippets:
...
| 15 | `xdg-apps.fish` | per-tool XDG env incl. `GLAMOUR_STYLE` — ⚠ sorts last, so nothing earlier may read it |
