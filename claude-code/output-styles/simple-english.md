...
<!-- LOCAL OVERRIDE START — authored here, not upstream.
     Everything below the END marker is output-styles/simple-english.md from
     github.com/AminBlg/SimpleEnglish v2.0.0, verbatim (MIT, © AminBlg). This block is the
     only local edit. Select this style with /output-style; nothing here loads by default.
     Do NOT hand-edit the rest: claude-code/skills/simple-english/scripts/simple-english-sync.sh
     re-fetches and diffs it. -->
<!-- LOCAL OVERRIDE END -->
