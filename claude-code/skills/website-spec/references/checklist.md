<!-- VENDORED VERBATIM from https://specification.website/checklist.md
     Fetched 2026-09-01 · Content licensed CC BY 4.0 · © Joost de Valk
...
- [ ] [_for-sale DNS records](https://specification.website/spec/foundations/for-sale-dns/) — Optional
...
- [ ] [Focus not obscured](https://specification.website/spec/accessibility/focus-not-obscured/) — Recommended
  A focused control must not be hidden behind a sticky header, cookie banner, or chat widget. WCAG 2.2 added this as a separate criterion because a perfect focus ring is worthless if something is sitting on top of it.
...
- [ ] [Consistent help](https://specification.website/spec/accessibility/consistent-help/) — Recommended
...
- [ ] [X-XSS-Protection](https://specification.website/spec/security/x-xss-protection/) — Avoid
...
- [ ] [Redirect-By header](https://specification.website/spec/resilience/redirect-by/) — Recommended
  The Redirect-By response header names the software that issued a redirect, so anyone debugging a redirect chain can see at a glance which system to fix. It is deployed today under the legacy name X-Redirect-By.
